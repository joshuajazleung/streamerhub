...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "d31b4f081ad446f940db";
...
eval("const path = __webpack_require__(/*! path */ \"path\"); // const CleanWebpackPlugin = require('clean-webpack-plugin');\n\n\nconst HtmlWebpackPlugin = __webpack_require__(/*! html-webpack-plugin */ \"html-webpack-plugin\");\n\nconst VueLoaderPlugin = __webpack_require__(/*! vue-loader/lib/plugin */ \"vue-loader/lib/plugin\");\n\nconst webpack = __webpack_require__(/*! webpack */ \"webpack\");\n\nmodule.exports = {\n  entry: ['webpack-hot-middleware/client?path=/__webpack_hmr&timeout=20000', './src/assets/index.js'],\n  output: {\n    filename: '[name].[hash].bundle.js',\n    path: path.join(__dirname, 'dist'),\n    publicPath: '/'\n  },\n  devServer: {\n    contentBase: './dist',\n    stats: 'errors-only'\n  },\n  optimization: {\n    noEmitOnErrors: true\n  },\n  mode: 'development',\n  devtool: 'cheap-eval-source-map',\n  node: {\n    fs: 'empty'\n  },\n  target: 'web',\n  module: {\n    rules: [{\n      test: /\\.js$/,\n      loader: 'babel-loader',\n      exclude: /node_modules/\n    }, {\n      test: /\\.css$/,\n      use: ['vue-style-loader', // \"style-loader\", // creates style nodes from JS strings\n      'css-loader', // translates CSS into CommonJS\n      {\n        loader: 'postcss-loader',\n        options: {\n          plugins: () => [__webpack_require__(/*! postcss-cssnext */ \"postcss-cssnext\")(), __webpack_require__(/*! postcss-custom-properties */ \"postcss-custom-properties\")()]\n        }\n      }]\n    }, {\n      test: /\\.html$/,\n      loader: 'html-loader'\n    }, {\n      test: /\\.vue$/,\n      loader: 'vue-loader'\n    }, {\n      enforce: 'pre',\n      test: /\\.(js|vue)$/,\n      exclude: /node_modules/,\n      loader: 'eslint-loader',\n      options: {\n        formatter: __webpack_require__(/*! eslint-friendly-formatter */ \"eslint-friendly-formatter\"),\n        fix: true\n      }\n    }, {\n      test: /\\.(jpg|png|gif|svg|pdf|ico)$/,\n      use: [{\n        loader: 'file-loader',\n        options: {\n          name: '[path][name]-[hash:8].[ext]'\n        }\n      }]\n    }]\n  },\n  plugins: [// new CleanWebpackPlugin(['./dist']),\n  new HtmlWebpackPlugin({\n    title: 'Output Management',\n    template: './src/assets/views/index.html',\n    filename: 'index.html'\n  }), new VueLoaderPlugin(), new webpack.HotModuleReplacementPlugin()]\n};\n\n//# sourceURL=webpack:///./webpack.config.js?");
...
eval("module.exports = require(\"eslint-friendly-formatter\");\n\n//# sourceURL=webpack:///external_%22eslint-friendly-formatter%22?");
...
eval("module.exports = require(\"postcss-cssnext\");\n\n//# sourceURL=webpack:///external_%22postcss-cssnext%22?");

/***/ }),

/***/ "postcss-custom-properties":
/*!********************************************!*\
  !*** external "postcss-custom-properties" ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports) {

eval("module.exports = require(\"postcss-custom-properties\");\n\n//# sourceURL=webpack:///external_%22postcss-custom-properties%22?");
